            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top " id="navigation-example">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        <a class="navbar-brand" href="javascript:void(0)">Testimonials</a>
                    </div>
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $statement = "`tbl_user_testimonials`";
                                                
                                                // Pagination End

                                                $tstimonInfodata = array();
                                                $tstimonInfoquery = "SELECT `testimonial_id`, `username`, `testimonial_text`, `status`, `date` FROM {$statement} ORDER BY `testimonial_id` DESC LIMIT {$startpoint} , {$limit}";
                                                ...
                                                foreach ($tstimonInfodata as $tstimonInfoRow) {
                                                    echo '
                                                        <tr>
                                                            <td class="text-truncate" style="max-width: 150px;">' . $tstimonInfoRow['testimonial_text'] . '</td>
                                                            <td>' . $tstimonInfoRow['username'] . '</td>
                                                            <td>' . $tstimonInfoRow['status'] . '</td>
                                                            <td>' . forEmptyDate($tstimonInfoRow['date']) . '</td>
                                                            <td><a class="btnn btn-outline-sxc" href="view.php?tstid='.encode($tstimonInfoRow['testimonial_id']).'">Update</a></td>
                                                        </tr>
                                                    ';
                                                }
                                            ?>
